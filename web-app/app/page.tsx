            ...
            >
              ...
              <div className="p-6 border-b border-slate-700/50">
                ...
                <div className="grid grid-cols-3 gap-4 items-center mb-4">
                  ...
                  <div className="text-center">
                    <div className={`bg-gradient-to-r ${getCompetitionColor(selectedCompetition)}/20 border ${getCompetitionColor(selectedCompetition).replace('from-', 'border-').replace(' to-green-600', '').replace(' to-orange-600', '').replace(' to-pink-600', '')}/40 rounded-full py-3 px-6`}>
                ...
                <button
                  ...
                  className="w-full mt-4 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-emerald-500/20 to-green-600/20 hover:from-emerald-500/30 hover:to-green-600/30 border border-emerald-500/30 rounded-lg transition-all duration-200 font-semibold text-emerald-400"
                >
                  <span>Ver {partido.picks.length} Picks Avanzados</span>
